     ...
     <div class="signup-main">  	
    	 <div class="signup-head">
			...
			<div class="signup-block">
				<form method="post" enctype="multipart/form-data" action="{{url('cars/create')}}">
					@csrf
                ...
                <select class="form-control show-tick" name="transmission" required="">
                ...
                <select class="form-control show-tick" name="make" required="">
